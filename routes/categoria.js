...
router.get('/show/:id', param('id').custom(id => {
        return categoriaValidator.exists(id)
    }), validator.returnErrors,
    controller.show)
router.put('/update/:id', param('id').custom(id => {
    return categoriaValidator.exists(id)
}), validator.returnErrors, controller.update)

router.delete('/delete/:id', param('id').custom(id => {
    return categoriaValidator.exists(id)
}), validator.returnErrors, controller.delete)
